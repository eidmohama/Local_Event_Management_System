...
5. **Error Handling and Validation**
  ...
  In addition to basic validation, exception handling was implemented in the application to help prevent errors from crashing the application and to gracefully handle errors associated with the database.
