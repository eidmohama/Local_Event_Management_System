...
The main challenge faced by the development team was keeping the GUI and the database in sync; the team was able to solve this by re-loading the data after each CRUD operation was performed.
